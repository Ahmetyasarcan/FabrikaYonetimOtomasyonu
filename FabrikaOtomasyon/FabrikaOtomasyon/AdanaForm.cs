...
{
    public partial class AdanaForm : Form
    {
        public AdanaForm()
        {
            InitializeComponent();
            ...
            gMapControl1.Position = new PointLatLng(37.46759068077521, 35.76294); // Merkez konumu (örnek: İstanbul)
            ...
            GMapMarker centrumMarker = new GMarkerGoogle(
                new PointLatLng(37.46759068077521, 35.76294), // Merkezin koordinatları
                GMarkerGoogleType.red_dot); // Marker tipi: kırmızı nokta

            centrumMarker.ToolTipText = "Adana Fabrika"; // Marker üzerine metin ekleme
        ...
        private void AdanaForm_Load(object sender, EventArgs e)
        {
