...
{
    public partial class NigdeForm : Form
    {
        public NigdeForm()
        {
            InitializeComponent();
            ...
            gMapControl1.Position = new PointLatLng(38.04857345703337, 34.76081433862645); // Merkez konumu (örnek: İstanbul)
            ...
            GMapMarker centrumMarker = new GMarkerGoogle(
                new PointLatLng(38.04857345703337, 34.76081433862645), // Merkezin koordinatları
                GMarkerGoogleType.red_dot); // Marker tipi: kırmızı nokta

            centrumMarker.ToolTipText = "Niğde Fabrika"; // Marker üzerine metin ekleme
        ...
        private void NigdeForm_Load(object sender, EventArgs e)
        {
